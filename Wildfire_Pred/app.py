...
if not AERIS_CLIENT_ID or not AERIS_CLIENT_SECRET:
    print("⚠️ WARNING: AERIS_CLIENT_ID and AERIS_CLIENT_SECRET not found in environment variables.")
    print("📝 Please create a .env file with your API credentials.")
    print("🔗 Get your API keys at: https://www.aerisweather.com/")
    # Use demo credentials for development (limited functionality)
    AERIS_CLIENT_ID = os.getenv('AERIS_CLIENT_ID', 'demo')
    AERIS_CLIENT_SECRET = os.getenv('AERIS_CLIENT_SECRET', 'demo')
